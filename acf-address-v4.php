	...
	function create_options( $field )
	{
		...
		<tr class="field_option field_option_<?php echo $this->name; ?>">
			<td class="label">
				...
				<p class="description">
					<strong><?php _e( 'Enabled', 'acf' ); ?></strong>: <?php _e( 'Is this component used.', 'acf' ); ?><br />
					<strong><?php _e( 'Label', 'acf' ); ?></strong>: <?php _e( 'Used on the add or edit a post screen.', 'acf' ); ?><br />
					<strong><?php _e( 'Default Value', 'acf' ); ?></strong>: <?php _e( 'Default value for this component.', 'acf' ); ?><br />
					<strong><?php _e( 'CSS Class', 'acf' ); ?></strong>: <?php _e( 'Class added to the component when using the api.', 'acf' ); ?><br />
					<strong><?php _e( 'Separator', 'acf' ); ?></strong>: <?php _e( 'Text placed after the component when using the api.', 'acf' ); ?><br />
				</p>
			</td>
			<td>
				<table>
